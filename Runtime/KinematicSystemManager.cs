...
namespace KinematicMovementSystem
{
	...
	public class KinematicSystemManager : MonoBehaviour
	{
		private static KinematicSystemManager _instance;

		public static List<KinematicMovementSystem.KinematicCharacterMotor> CharacterMotors = new List<KinematicMovementSystem.KinematicCharacterMotor>();
		public static List<KinematicMovementSystem.KinematicPhysicsMover> PhysicsMovers = new List<KinematicMovementSystem.KinematicPhysicsMover>();

		private static float _lastCustomInterpolationStartTime = -1f;
		private static float _lastCustomInterpolationDeltaTime = -1f;

		public static KinematicSystemSettings Settings;
		...
		public static void EnsureCreation()
		{
			if (_instance == null)
			{
				...
				_instance = systemGameObject.AddComponent<KinematicSystemManager>();

				systemGameObject.hideFlags = HideFlags.NotEditable;
				_instance.hideFlags = HideFlags.NotEditable;

				Settings = ScriptableObject.CreateInstance<KinematicSystemSettings>();
		...
		/// </summary>
		/// <returns></returns>
		public static KinematicSystemManager GetInstance()
		{
			return _instance;
		}
		...
		/// </summary>
		public static void RegisterCharacterMotor(KinematicMovementSystem.KinematicCharacterMotor motor)
		{
		...
		/// </summary>
		public static void UnregisterCharacterMotor(KinematicMovementSystem.KinematicCharacterMotor motor)
		{
		...
		/// </summary>
		public static void RegisterPhysicsMover(KinematicPhysicsMover mover)
		{
		...
		/// </summary>
		public static void UnregisterPhysicsMover(KinematicPhysicsMover mover)
		{
		...
		public static void PreSimulationInterpolationUpdate(float deltaTime)
		{
			...
			{
				KinematicMovementSystem.KinematicCharacterMotor motor = CharacterMotors[i];
			...
			{
				KinematicPhysicsMover mover = PhysicsMovers[i];
		...
		/// </summary>
		public static void Simulate(float deltaTime, List<KinematicMovementSystem.KinematicCharacterMotor> motors, List<KinematicPhysicsMover> movers)
		{
...
#pragma warning disable 0162
			...
			for (int i = 0; i < physicsMoversCount; i++)
			{
				KinematicPhysicsMover mover = movers[i];
			...
			for (int i = 0; i < characterMotorsCount; i++)
			{
				KinematicMovementSystem.KinematicCharacterMotor motor = motors[i];
