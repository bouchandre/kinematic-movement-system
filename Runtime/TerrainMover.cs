...
namespace KinematicMovementSystem
{
	...
	public class TerrainMover : MonoBehaviour
    {
        ...
        /// </summary>
        /// 
        [Tooltip("Determines if the platform moves with rigidbody.MovePosition (when true), or with rigidbody.position (when false)")]
		...
		{
			Rigidbody tmpCapsule = gameObject.GetComponent<Rigidbody>();
		...
		public void ValidateData()
        {
			...
			_body.maxDepenetrationVelocity = Mathf.Infinity;
        ...
        private void OnEnable()
        {
            ...
            KinematicSystemManager.RegisterPhysicsMover(this);
        }

        private void OnDisable()
        {
            KinematicSystemManager.UnregisterPhysicsMover(this);
        }
        ...
        private void Awake()
        {
            ...
            TransientPosition = _body.position;
            TransientRotation = _body.rotation;
            InitialSimulationPosition = _body.position;
            InitialSimulationRotation = _body.rotation;
